            ...
            <div className="bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-cyan-500/30">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-700/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    ReactJS, FastAPI, vLLM, Qwen2.5-7B-Instruct
                  </p>
                </div>
                <div className="bg-gray-700/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    128K context, 300 KB shared context
                  </p>
                </div>
              </div>
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-300">
                    Developed ContextGPT, a multi-user enterprise LLM assistant
                    using ReactJS, FastAPI, vLLM, and Qwen2.5-7B-Instruct.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Zap className="w-5 h-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-300">
                    Deployed long-context inference on Podstack cloud GPUs via
                    SSH using FP8 inference and tested on 3+ concurrent users.
                  </span>
                </li>
              </ul>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  className="glow-button inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-5 py-2.5 rounded-full font-semibold hover:scale-105 transition-all duration-300"
                >
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm flex items-center gap-2 mt-1">
                    <Calendar className="w-4 h-4" /> June 2025 - June 2025
                  </p>
                </div>
              </div>
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-start gap-3">
                  <Zap className="w-5 h-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-300">
                    Built a logistics route optimization system solving
                    real-world delivery inefficiencies.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Zap className="w-5 h-5 text-yellow-400 mt-0.5 flex-shrink-0" />
                  <span className="text-gray-300">
                    Integrated OSRM, CSV upload, customer management, and route
                    visualization.
                  </span>
                </li>
              </ul>
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  id="project-demo-btn"
                  onClick={openModal}
                  className="glow-button inline-flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-5 py-2.5 rounded-full font-semibold hover:scale-105 transition-all duration-300 cursor-pointer"
                >
                  <Play className="w-4 h-4" />
                  Project Demo
                </button>
                <a
                  href="https://github.com/kiahcodes/TruckRouting.git"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="glow-button inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white px-5 py-2.5 rounded-full font-semibold transition-all duration-300"
                >
